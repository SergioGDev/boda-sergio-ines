...
import { InvitadoSchema, NOMBRE_ASC, NOMBRE_DESC, MESA_ASC, MESA_DESC, 
  MesaSchema, NUMERO_ASC, NUMERO_DESC, HeroeSchema, MesaData, InvitadoData } from '../../../interfaces/datos.interfaces';
...
export class GestionInvitadosComponent implements OnInit {
  ...
  cargarDatosMesas(vMesas: MesaData[]) {
    this.cargandoInvitados = true;

  }

  cargarDatosInvitados(data: InvitadoData[]) {
    this.mesasFireService.saveInvitados(data).then( resp => console.log('TODO OK:', resp), err => console.log('HA OCURRIDO UN ERROR:', err))
