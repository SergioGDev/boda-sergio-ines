...
export class UbicacionesComponent implements AfterViewInit, OnInit {
  ...
  ngAfterViewInit(): void {
    ...
    mapaParador['scrollZoom'].disable();
    mapaParador['boxZoom'].disable();
    mapaParador['dragRotate'].disable();
    mapaParador['dragPan'].disable();
    mapaParador['keyboard'].disable();
    mapaParador['doubleClickZoom'].disable();
    mapaParador['touchZoomRotate'].disable();
    ...
    const markerParador2 = new mapboxgl.Marker()
      ...
      mapaParador2['scrollZoom'].disable();
      mapaParador2['boxZoom'].disable();
      mapaParador2['dragRotate'].disable();
      mapaParador2['dragPan'].disable();
      mapaParador2['keyboard'].disable();
      mapaParador2['doubleClickZoom'].disable();
      mapaParador2['touchZoomRotate'].disable();
  }
